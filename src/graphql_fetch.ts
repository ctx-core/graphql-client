...
export function graphql_fetch<data_type extends unknown = unknown>(
	...
	return in_graphql_fetch(body, fn_in_http_opts) as Promise<graphql_fetch_response_I<data_type>>
}
export interface graphql_fetch_response_I<data_type extends unknown = unknown> {
	data: data_type
}
export type graphql_fetch_response_type = graphql_fetch_response_I
export {
